              ...
              <form className="mt-6" onSubmit={handleSubmit}>
                <div className="mb-2">
                  ...
                  <input
                    ...
                    className="block  px-4 py-2 mt-2  bg-white border rounded-md focus:border-red-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
                  />
                  <input
                    type="text"
                ...
                <div className="mb-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) => handleChange(e)}
                    className="block  px-2 py-2 mt-2  bg-white border rounded-md focus:border-red-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
                  />
                </div>
                ...
                <div className="mt-6">
                  <button className="w-3/4 px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-red-700 rounded-md hover:bg-red-600 focus:outline-none focus:bg-purple-600">
                    ยืนยันข้อมูล
                  </button>
                </div>
              </form>
