                                    ...
                                    <form className="mt-6">
                                        ...
                                        <div className="mb-2">
                                            ...
                                            <textarea
                                                ...
                                                className="block w-full px-2 py-2 mt-2 text-red-700 bg-white border rounded-md focus:border-red-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                            />
                                        </div>
                                        <div className="mb-2">
                                            <label
