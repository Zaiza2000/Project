      ...
      <div className="">
        <div className="xl:w-96 mt-6 ">
          ...
          <div className="input-group relative items-stretch w-full mb-4">
            <input
              type="search"
              className="form-control mb-6 relative  min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              placeholder="Search"
              aria-label="Search"
